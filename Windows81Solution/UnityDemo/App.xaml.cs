...
namespace Template
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            args.Request.ApplicationCommands.Add(new SettingsCommand("privacy", "Privacy Policy", command =>
            {
                Launcher.LaunchUriAsync(new Uri("http://privacy.policy", UriKind.Absolute));
            }));
        }
